  ...
  try {
    ...
    const result = await axios.post(
      `https://marketer.modash.io/api/discovery/search/instagram`,
      {
        ...
        page: pagenumber,
        sort: {"direction":"asc","field":"followers","sortedValue":"Follower range"},
      },
      {
    ...
    const path_tosave = `../data_scraper/scraped_data/modash/listprofiles/100k-175k/data_${pagenumber}.json`;
